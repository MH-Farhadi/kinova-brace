...
parser = argparse.ArgumentParser(description="This script demonstrates Kinova jaco2 arm manipulators.")
...
def design_scene() -> tuple[dict, list[list[float]]]:
    ...
    # dynamic import to avoid static linter issues outside Isaac Sim runtime
    import importlib
    ...
    cfg = sim_utils.UsdFileCfg(
        ...
        scale=(1.5, 2., 1.0),  # widen slightly in X/Y, keep height
    )
    cfg.func("/World/Origin1/Table", cfg, translation=(0.0, 0.0, 0.8))
    # -- Robot
    kinova_j2n6_cfg = dc_replace(KINOVA_JACO2_N6S300_CFG, prim_path="/World/Origin1/Robot")
    kinova_j2n6_cfg.init_state.pos = (0.0, 0.0, 0.8)
