...
from data_collection.tasks.spec import TaskSpec


def add_cli_args(parser: argparse.ArgumentParser) -> None:
    """CLI args for the reach-to-grasp data collection pipeline."""
...
def run(args: argparse.Namespace) -> int:
    ...
    from data_collection.demo import run_data_collection
